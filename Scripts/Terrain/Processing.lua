...
dofile("$CONTENT_DATA/Scripts/Terrain/CustomTiles.lua")
...
function evaluateRoadsAndCliffs()
	...
	forEveryCell( function( cellX, cellY )
		if getRoadCliffFlags( cellX, cellY ) ~= 0 then
			g_cornerTemp.type[cellY][cellX] = TYPE_DESERT
			g_cornerTemp.type[cellY][cellX + 1] = TYPE_DESERT
			g_cornerTemp.type[cellY + 1][cellX] = TYPE_DESERT
			g_cornerTemp.type[cellY + 1][cellX + 1] = TYPE_DESERT
		end
	end )
